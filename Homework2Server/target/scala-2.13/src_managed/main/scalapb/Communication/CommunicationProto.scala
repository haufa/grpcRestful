...
object CommunicationProto extends _root_.scalapb.GeneratedFileObject {
  ...
  2VudBImCgdlbnRyaWVzGAIgAygJQgziPwkSB2VudHJpZXNSB2VudHJpZXMySQoQaXNQcmVzZW50U2VydmljZRI1Cg1TZWFyY2hSZ
  XF1ZXN0EhEuaXNQcmVzZW50UmVxdWVzdBoPLmlzUHJlc2VudFJlcGx5IgBiBnByb3RvMw=="""
      ).mkString)
